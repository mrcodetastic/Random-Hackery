...
void loop() {
   ...
   for (int x = 0; x <  dma_display.width(); x++) {
         ...
         */
         switch (LayerCompositor_mode)
         {
          case 3: // flag
          {
            ...
            bgLayer.fillScreen(CRGB(250,250,250));   
            CRGB value = CRGB(252,36,28);
            bgLayer.fillRect(27,0,8,32, value);
            bgLayer.fillRect(0,12,64,8, value);  
          ...
          case 0:
      {
            bgLayer.clear();   
            textLayer.clear();            
            textLayer.drawCentreText("IT'S", MIDDLE, &FreeSansBold9pt7b, CRGB(252,36,28));
          ...
          case 1:
{
            textLayer.clear();    
            bgLayer.clear();               
            textLayer.drawCentreText("COMIN", MIDDLE, &FreeSansBold9pt7b, CRGB(255,255,255));
            textLayer.autoCenterX(); // because I don't trust AdaFruit to perfectly place the contents in the middle
            LayerCompositor::Stack(dma_display, bgLayer, textLayer);
} 
            break;
          ...
          case 2:
{
             ...
             */
            textLayer.clear();               
            textLayer.drawCentreText("HOME!", MIDDLE, &FreeSansBold9pt7b, CRGB(255,255,255));
            textLayer.autoCenterX(); // because I don't trust AdaFruit to perfectly place the contents in the middle               
        ...
        EVERY_N_SECONDS(2) { // FastLED Macro
          LayerCompositor_mode++;
          dma_display.clearScreen();
          if (LayerCompositor_mode > 3) LayerCompositor_mode = 0;          
        }         
