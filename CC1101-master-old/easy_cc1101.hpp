...
******************************************************************************/
// Select (SPI) CC1101 
#define cc1101_Select()  digitalWrite(_cs, LOW)

// Deselect (SPI) CC1101
#define cc1101_Deselect()  digitalWrite(_cs, HIGH)

// Wait until SPI MISO line goes low
#define wait_Miso()  while(digitalRead(_miso)>0)
...
class CC1101
{
  private:
	...
	// Spi
	gpio_num_t _sclk, _mosi, _miso, _gd0;
	uint8_t _cs;
	uint32_t _freq;  	
	...
	uint8_t CC1101_GDO0_interrupt_pin = -1;
  ...
  public:    
	...
	bool begin(CFREQ freq, uint8_t channr, uint8_t addr, uint8_t clk_pin, uint8_t miso_pin, uint8_t mosi_pin, uint8_t slave_select_pin);
